kUtil.loop_try_repalce_function(_G, "InputManager", "_send_input", function (self, target, mapping)
    ...
    for _, value in pairs(mapping) do
        ...
        if value.index then
            ...
            local gamepad_value = GamepadSupportMod.gamepad_mapper and GamepadSupportMod.gamepad_mapper:is_input_active(value.output, value.func) or false
            if gamepad_value then
                if type(val) == "number" then
                    ...
                    if is_cursor then
                        ...
                        Window.set_cursor_position(Vector2(new_x, new_y))
            ...
            elseif input_data.cursor then
                ...
                if GamepadSupportMod.gamepad_mapper then
                    ...
                    if move_axis then
                        ...
                        intersect_pos = unit_world_position + move_dir * 2
                    end
                end
                ...
                if intersect_pos and (input_data.do_move > 0.5 and not ignore_click and internal.was_clicked or input_data.set_move_target and not ignore_click) and input_data.move_stop == 0 then
